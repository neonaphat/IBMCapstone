...
def update_pie_chart(launch_site):
    if launch_site == 'All Sites':
        ...
        fig = px.pie(pie_data, values='class', names='Launch Site', title='Total Success Launches by Site')
    else:
        ...
        fig = px.pie(success_counts, values='Count', names='Outcome', title=f'Total Success Launches for {launch_site}')
    return fig
